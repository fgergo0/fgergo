...
function afastat() {
    ...
    document.getElementById("kint").innerHTML = "<table class='buttontable'><tr><td class='balra'>Kintlévőségek összesen:</td><td class='jobbra'>" + localStorage.getItem("kintlevoseg") + " Ft</td></tr></table>";
    document.getElementById("tart").innerHTML = "<table class='buttontable'><tr><td class='balra'>Tartozások összesen:</td><td class='jobbra'>" + localStorage.getItem("tartozas") + " Ft</td></tr></table>";
